...
resource "ibm_is_subnet_public_gateway_attachment" "attachment01" {
  subnet                = ibm_is_subnet.subnet1.id
  public_gateway         = ibm_is_public_gateway.vpc_public_gateway_zone_1.id
}


resource "ibm_is_subnet_public_gateway_attachment" "attachment02" {
  subnet                = ibm_is_subnet.subnet2.id
  public_gateway         = ibm_is_public_gateway.vpc_public_gateway_zone_2.id
}


resource "ibm_is_subnet_public_gateway_attachment" "attachment03" {
